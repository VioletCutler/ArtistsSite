import "../../styles/phillyskyline.css";

const PhillySkyline = () => {
  return (
    <main>
      <h1>Philly Skyline</h1>
      <iframe
        width="100%"
        height="600"
        src="https://www.youtube-nocookie.com/embed/UzM2O4fIS-Y?autoplay=1&modestbranding=1&rel=0&color=white&disablekb=1"
